...
- ファイル：[methods/014_bujutsu-template-method.md](./methods/014_bujutsu-template-method.md)
- 目的：同じ素材を固定したまま、武術ごとの作用点を演出・文章・広告・Web・映像・ライブ・会議・教育・AI出力へ移植し、制作・分析・修理を比較する。
- 重要：最初に相撲型で **土俵内／場外／比較条件／終了条件** を固定する。流派は雰囲気ではなく **作用点＋操作＋結果** で判定する。
- 合図：`この素材を武術テンプレ法©️ v1.1で変換して。`
